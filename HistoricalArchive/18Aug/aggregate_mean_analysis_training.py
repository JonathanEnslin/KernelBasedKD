...
def main(args):
    ...
    loss_handler.add_eval_criterion("S1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'target_model': 'teacher',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("T1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'target_model': 'student',
        'pre_aggregate_decorators': [torch.abs],
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("S2", FilterAnalysis(model, teacher, **opts))
    opts = {
        'target_model': 'teacher',
        'pre_aggregate_decorators': [torch.abs],
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("T2", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [0],
        'target_model': 'student',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("S1_0", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [0],
        'target_model': 'teacher',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("T1_0", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [0],
        'target_model': 'student',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("S2_0", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [0],
        'target_model': 'teacher',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("T2_0", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [1],
        'target_model': 'student',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("S1_1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [1],
        'target_model': 'teacher',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("T1_1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [1],
        'target_model': 'student',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("S2_1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [1],
        'target_model': 'teacher',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("T2_1", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [2],
        'target_model': 'student',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("S1_2", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [2],
        'target_model': 'teacher',
        'initial_aggregate_fn': torch.mean,
    }
    loss_handler.add_eval_criterion("T1_2", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [2],
        'target_model': 'student',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("S2_2", FilterAnalysis(model, teacher, **opts))
    opts = {
        'collect_indices': [2],
        'target_model': 'teacher',
        'pre_aggregate_decorators': [torch.abs],
    ...
    loss_handler.add_eval_criterion("T2_2", FilterAnalysis(model, teacher, **opts))

...
def kfold_objective(param, eval_index, folds, full_dataset, num_classes, device, log_dir, 
    ...
    kd_criterion = ATLoss(student=stu_model, 
                          teacher=tea_model, 
                          cached_pre_activation_fmaps=tea_preactivation_fmaps, 
                          cached_post_activation_fmaps=tea_postactivation_fmaps, 
                          device=device, 
                          mode='impl',
...
def main(dataset_name="CIFAR10", requested_device="cuda", runtime='xxx', log_dir="hpar_tuning_logs/vanilla", 
         ...
         student_type='resnet20', teacher_type='resnet56', teacher_path='xxx', use_cached_values=False, use_starting_points=False):
        ...
        search: pyhopper.Search = pyhopper.Search(
            {
                ...
                "beta": pyhopper.float(0.0, 4000.0, init=1000.0) if use_starting_points else pyhopper.float(0.0, 4000.0),
            }
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use-starting-points', action='store_true', help='Use starting hardcoded starting points for the search')
    ...
    main(
        ...
        log_dir="hpar_tuning_logs/attention",
        name=args.name,
        ...
        use_starting_points=args.use_starting_points
    )
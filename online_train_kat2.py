...
if __name__ == '__main__':
    ...
    # KD variables
    kd_criterion = FilterAttentionTransfer(student=student, teacher=teacher, map_p=1.845, loss_p=2, use_abs=True, mean_targets=['C_out', 'C_in'], layer_groups='all')
    teacher_kd_criterion = FilterAttentionTransfer(student=teacher, teacher=student, map_p=1.845, loss_p=2, use_abs=True, mean_targets=['C_out', 'C_in'], layer_groups='all')

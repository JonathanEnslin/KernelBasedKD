...
class TestStep(EvaluationStep):
    def __init__(self, model, testloader, criterion, device, writer, csv_file, start_time, autocast, logger=print, no_write=False):
        super().__init__(model, testloader, criterion, device, writer, csv_file, start_time, autocast, mode='test', logger=logger, no_write=no_write)

...
python train.py --run_name resnet20_params3_CIFAR10_run4 --params ./params.json --param_set params3 --model_name resnet20 --use_val --val_size 0.1 --disable_test --early_stopping_patience 15 --early_stopping_start_epoch 90 --dataset CIFAR10 --device cpu --val_split_random_state 112 --track_best_after_epoch 80
echo '================================================='

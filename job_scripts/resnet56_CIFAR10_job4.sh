...
#PBS -o /mnt/lustre/users/jenslin/cpu_training_1/KernelBasedKD/job_out/job4.out
#PBS -e /mnt/lustre/users/jenslin/cpu_training_1/KernelBasedKD/job_out/job4.err
#PBS -P CSCI1166
#PBS -m abe

...
#PBS -o /mnt/lustre/users/jenslin/cpu_training_1/KernelBasedKD/job_out/job3.out
#PBS -e /mnt/lustre/users/jenslin/cpu_training_1/KernelBasedKD/job_out/job3.err
#PBS -P CSCI1166
#PBS -m abe

...
class ResNet(BaseModel):
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        # TODO: Return all feature maps, not just layer group ones, will need to adapt other code though
        self.pre_activation_fmaps = [f1_pre, f2_pre, f3_pre]
        self.post_activation_fmaps = [f1, f2, f3]
